...
export default function Navbar() {
  return (
    <main className="flex">
      <div className=" bg-deepestBlue basis-1/5 flex  items-center gap-3 pl-5 py-2">
      ...
      <div className=" bg-deeperBlue basis-4/5 pr-5 flex justify-end items-center gap-4">
